...
The second half of the day shifted toward Linux capture correctness and contributor workflow. Selector preference handling was hardened, workflow edits became staged until save, region-capture modifier and portal hotkey cleanup closed correctness gaps, diagnostics started surfacing the last runtime selector decision, and the opening `XIP0052` proposal quickly turned into concrete DI, pipeline, and MVVM refactor work before the day ended. Late-night docs work also refreshed the March 14 and March 15 daily draft files so the documentation trail kept pace with the release and refactor stream.
...
- Closed the day by refreshing the March 14 and March 15 blog drafts, which keeps the daily-dev log caught up with the same-day code and release history.
...
- `9bcd62e7` `[v0.20.4] [Docs] Add 2026-03-14 Linux capture and surface polish blog draft.`
- `0d8df6fd` `[v0.20.4] [Docs] Add 2026-03-15 theme, Linux capture, and release blog draft.`
...
- The late-night docs commits for March 14 and March 15 were authored after 23:00 UTC+8 on March 15, so they belong to this day's reviewed history even though one of them updates the previous day's blog file.
