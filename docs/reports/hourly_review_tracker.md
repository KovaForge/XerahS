...
- Follow-up: Continue capture pipeline review around monitor-output disposal paths during DXGI enumeration/setup failures and finish pushing the queued local commits once GitHub App auth is available.
