...
## Legacy content from `XIP0015-workflow-configuration-image-effects.md`
...
## Legacy content from `XIP0015_Workflow_ImageEffects.md`
...
## Deliverables
- Γ£à `WorkflowsConfig.json` usage implemented
- Γ£à Image Effects supported in workflows
