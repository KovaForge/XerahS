...
## Legacy content from `XIP0011-plugin-packaging-system-sxadp-installer.md`
...
## Legacy content from `XIP0011_Plugin_Packaging.md`
...
**File**: `src/desktop/core/XerahS.Uploaders/PluginSystem/PluginPackager.cs` (NEW)
...
**File 1**: `src/desktop/app/XerahS.UI/Views/PluginInstallerDialog.axaml` (NEW)
...
**File 2**: `src/desktop/app/XerahS.UI/ViewModels/PluginInstallerViewModel.cs` (NEW)
...
**File 3**: `src/desktop/app/XerahS.UI/Views/PluginInstallerDialog.axaml.cs` (NEW)
...
**File**: `src/desktop/app/XerahS.UI/ViewModels/ApplicationSettingsViewModel.cs`
...
## Deliverables
- Γ£à `PluginPackager.cs` with Package(), InstallPackage(), PreviewPackage()
- Γ£à `PluginInstallerDialog.axaml` + ViewModel + code-behind
- Γ£à Integration with ApplicationSettingsView
- Γ£à Build succeeds on `feature/plugin-packaging`
- Γ£à Manual test: Install a .sxadp package successfully
...
2. **Test installer UI**:
   - Run app ΓåÆ Settings ΓåÆ Uploaders
   - Click "Install Plugin..." button
   - Browse to `imgur.sxadp`
   - Verify manifest preview shows correctly
   - Click "Install"
...
[PluginPackager] Plugin installed: Imgur Uploader v1.0.0 to Plugins\imgur
[ProviderCatalog] Loading plugins from: Plugins
[ProviderCatalog] Γ£ô Loaded: Imgur Uploader
```
