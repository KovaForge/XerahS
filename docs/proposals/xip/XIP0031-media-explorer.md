...
UploaderInstance
    ╬ô├Ñ├┤
ProviderExplorerViewModel  ╬ô├Ñ├ë  IUploaderExplorer (optional)
    ╬ô├Ñ├┤
ProviderCatalog ╬ô├Ñ├å Provider Plugin
    ╬ô├Ñ├┤
...
## Legacy content from `XIP0031_Media_Explorer.md`
...
UploaderInstance
    Γåô
ProviderExplorerViewModel  ΓåÉ  IUploaderExplorer (optional)
    Γåô
ProviderCatalog ΓåÆ Provider Plugin
    Γåô
Remote Storage API (S3, Imgur, ...)
```
