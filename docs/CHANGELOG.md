...
### Features
- **Core**: Add Android About logo (0f77878e)
- **Core**: Add Android About screen parity (3c4821e7)
- **Core**: Add Android custom uploader imports (ebf8189e)
- **Core**: Add community plugin installer UX (2c007ee4)
- **Core**: Add encrypted destination config export (83cb0b6a)
- **Core**: Add experimental mobile About parity (1e2df055)
- **Core**: Add experimental mobile config imports (65bccfb9)
- **Core**: Add iOS About screen (5a11612a)
- **Core**: add OpenClaw CLI manifest (ade7138b)
- **Core**: Export OpenClaw upload plugin (6ea1bcfd)
- **Core**: Import destination configs on mobile (3be1a2ab)
- **Core**: Make iOS app use native SwiftUI shell (87e57083)
- **Core**: Merge iOS history into Home (e43c28d2)
- **Core**: support file-forced CLI uploads (e3e175ed)
- **Plugins**: add missing KFIP0004 test coverage for duplicate IDs, API version, and non-xsdp URL (c70e0b32)

### Fixes
- **Core**: Add Android credential privacy controls (6eab1c87)
- **Core**: Add Android upload consent state and cache cleanup (e8b1d1db)
- **Core**: add plugin native dependency fallback (e893b3ee)
- **Core**: align dxgi cursor overlay bounds (9fb1da25)
- **Core**: Align experimental mobile identity (a9ed8d51)
- **Core**: Align macOS overlay viewport mapping (c3d7e528)
- **Core**: Clean up Android launcher icons (198016d8)
- **Core**: clean up dxgi cursor replacement failures (925b42e7)
- **Core**: Clear stale OCR result state (151ef3e2)
- **Core**: compose cursor in DXGI region capture (a346d781)
- **Core**: Disable start screen in embedded editor (b2b3cdea)
- **Core**: dispose dxgi enumeration resources (fb7dbdac)
- **Core**: fallback when dxgi misses outputs (4717aff8)
- **Core**: Fit after capture preview to control (9bf074ca)
- **Core**: Handle Android shared media URIs reliably (6a0b390e)
- **Core**: Harden Android release build (481ad8af)
- **Core**: Harden Android share intent inputs (a90f6062)
- **Core**: harden dxgi cursor overlay (5bd46994)
- **Core**: ignore invalid plugin fallback assemblies (f051dd59)
- **Core**: Improve iOS share upload flow (135f4294)
- **Core**: Keep region annotation aiming visible (8b452e2c)
- **Core**: map dxgi rotated region captures (484b7d9a)
- **Core**: Match Android package ID to iOS (58b6e404)
- **Core**: match shared plugin dependencies case-insensitively (a61b3c7a)
- **Core**: persist uploader deletion metadata in history (880f354d)
- **Core**: Preserve Android upload completion results (05a24ad3)
- **Core**: Prevent chained macOS region selectors (4ad410f6)
- **Core**: Reapply macOS overlay window layout (23972adb)
- **Core**: Refine iOS share extension feedback (d1dc65d5)
- **Core**: require plugin dependency culture identity (3b891f5e)
- **Core**: require plugin dependency public key identity (c2d788e9)
- **Core**: Restore macOS region overlay alignment (63de089b)
- **Core**: retry dxgi full-screen frame acquisition (8dbfa13d)
- **Core**: scale dxgi crop rectangles (0b710391)
- **Core**: Secure Android uploader imports and endpoints (1e42e2ff)
- **Core**: Stabilize debug build (6ab2a45b)
- **Core**: Stabilize macOS native crosshair capture (888cd01b)
- **Core**: stop advertising dxgi cursor capture (18af748b)
- **Core**: Suppress macOS capture hotkeys (e68842d7)
- **Core**: Sync region annotation tools across monitors (a27233a3)
- **Core**: Upload from iOS share extension (dc02cded)
- **Core**: Validate plugin dependency metadata (2107e0c2)
- **Core**: Validate plugin preview asset paths (0f9493f2)
- **Core**: verify plugin fallback assembly identity (2b18c8f2)
- **Core**: Write daily and weekly settings backups (900763be)
- **Linux**: store Flatpak autostart marker in XDG state (47109600)
- **Media**: FFmpegCLIManager GetVideoInfo missing closing quote in FFmpeg args (9178a566)
- **Media**: VideoThumbnailer off-by-one in GetRandomTimeSlice, bitmap leak in CombineScreenshots (5c19ef8e)

### Build
- **Core**: split hourly review tracker state (66919e1f)
- **Core**: update ShareX.VideoEditor to (26fc5e49)
- **Core**: Update VideoEditor WebUI integration (d3101276)

### Documentation
- **Core**: Add Android Play submission checklist (2b05ddd1)
- **Core**: Add Android Play submission materials (a48dbe05)
- **Core**: add community destination plugins listing (331ae6a4)
- **Core**: Add experimental mobile parity workflow (777d7af9)
- **Core**: Add first-party integration prompt template (8084cd29)
- **Core**: add Linux XDG and Flathub readiness XIP (a0b9a8fe)
- **Core**: Add mobile parity workflow (ddbcaab6)
- **Core**: Add OpenClaw plugin setup guide (f29542a0)
- **Core**: Blog drafts (2026 series, add/update) (03095c6b, 06459679, 067be5f5, 07db2718, 09e5a718, 0d81f8a3, 14d8a6d6, 1610b143, 27e14ef8, 3acabb15, 4b254e01, 5100f787, 523099ed, 6053ec6e, 60ec6727, 71a5abdc, 844f147c, 85346893, 925ce5c1, 9f90e073, a5af5619, b18702bf, ca22c665, cfaed222, d48779c8, eb555a81, ee08007a, f7f14192)
- **Core**: Commit ImageEditor port items separately (e7296c54)
- **Core**: Compare ImageEditor port behavior (deda4c89)
- **Core**: Draft OpenClaw native upload plugin XIP (0b1bc2b2)
- **Core**: Explain macOS overlay layout guard (01dcea38)
- **Core**: Fix changelog markdown encoding (c4634a3b)
- **Core**: fix stale plugins-destinations reference in developers/README.md (53fe285c)
- **Core**: improve Pixelfox plugin formatting in plugins/destinations/README.md (336bb8b6)
- **Core**: Mark Android release build checks done (1ee270c7)
- **Core**: Move destination plugin registry docs (579d2a1a)
- **Core**: Point iOS to website privacy policy (ef454265)
- **Core**: Pull ShareX before ImageEditor port (c4d5cd39)
- **Core**: record hourly push blocker (a7855d18)
- **Core**: record Notifications/toasts and cross-platform history fix (2026-04-26 22:47 AWST) (58a776ed)
- **Core**: record Platform-specific services clipboard review (2026-04-26 13:47 UTC) (542b74ee)
- **Core**: Refresh 2026-04-25 engineering blog draft. (b24a6d47)
- **Core**: Refresh 2026-04-26 engineering blog draft. (892a8c68, 9f8412e9)
- **Core**: Refresh 2026-04-26 plugin-installer blog draft. (e800c81f)
- **Core**: Refresh 2026-04-28 stabilization blog draft. (163ba232, 619887f8)
- **Core**: Refresh 2026-04-29 release-readiness blog draft. (22105f57, c3fb9f79)
- **Core**: Refresh 2026-04-29 stabilization blog draft. (a6c6bb86)
- **Core**: Refresh 2026-04-30 config portability blog draft. (e08ea118)
- **Core**: Refresh 2026-04-30 mobile configuration blog draft. (82e17668)
- **Core**: Refresh 2026-05-01 mobile parity blog draft. (06e8ccdc)
- **Core**: Refresh 2026-05-02 Android and Flatpak blog draft. (2914c22d)
- **Core**: Refresh 2026-05-02 coding activity blog draft. (9933e386)
- **Core**: Refresh 2026-05-04 Android docs blog draft. (a2ae6d42)
- **Core**: Refresh 2026-05-05 plugin cleanup blog draft. (c6c0c535)
- **Core**: Refresh 2026-05-06 docs-maintenance blog draft. (62a11bbf)
- **Core**: Refresh 2026-05-06 plugin diagnostics blog draft. (8194d78c)
- **Core**: Refresh 2026-05-08 DXGI and ImageEditor blog draft. (9f8bd5bc)
- **Core**: rename plugins-destinations to destination-plugins (ff255f69)
- **Core**: Require ImageEditor port manifest (900e5658)
- **Core**: revert Pixelfox formatting to bullet list (63dc3c08)
- **Core**: sync tracker (759a70f1, bfe9a5f4)
- **Core**: sync tracker (2026-04-28 12:43 AWST) (ab5f59d1)
- **Core**: update hourly review tracker — CLI null deref fix 0.22.93→0.22.94 (88f40919)
- **Core**: update hourly review tracker — Media subsystem CombineScreenshots early-return fix (3ad6a853)
- **Core**: update hourly review tracker — Platform-specific services row (15:43 AWST) (a35dd145)
- **Core**: update hourly review tracker (2026-04-27 06:38 AWST) (a977be8f)
- **Core**: update hourly review tracker (Hotkeys/input re-review, v0.22.89) (9de26b76)
- **Core**: update hourly_review_tracker.md after Notifications/toasts review (5bdcd904)
- **Core**: Use website privacy policy for Android (8fa6a261)

### Testing
- **Core**: Add macOS native crosshair CLI verification (a3912800)

### Changed
- **Core**: [Design] KFIP0005-screen-capture-workflow-enhancements-for-social-sharing.md (99f6150d)
- **Core**: [Docs] Rename XIP0073 proposal file (3a5832e5)
- **Core**: [Fix] edited images are uploaded correctly (f90dfe13)
- **Core**: [Fix] Harden image effect preset loading (4ea26438)
- **Core**: [Flatpak] Use 512px app icon bucket (dd021d84)
- **Core**: [Flatpak] Use supported 256px app icon (4d8ded95)
- **Core**: [Indexer] Normalize extension filters (c1ad9ec1)
- **Core**: [KFIP] Screen Capture Workflow Enhancements for Social Sharing (b0c51d1f)
- **Core**: [Review] KFIP0005-screen-capture-workflow-enhancements-for-social-sharing.md (4a81a4ab)
- **Core**: [Uploaders] Normalize file type routing inputs (2c125ad0)
- **Core**: [v0.22.153] Harden plugin package extraction (227f0be6)
- **Core**: [v0.22.155] Harden plugin package path collisions (5078803b)
- **Core**: Add About tab (39ae88bf)
- **Core**: Add App Store screenshots (8e98ed3e)
- **Core**: Add App Store submission setup (3035a10c)
- **Core**: Add CLI directory index command (db835ba6)
- **Core**: Add community plugin registry installer (002897a3)
- **Core**: Add diagnostics logging when hotkey unregistration fails in WorkflowManager (ae77f591)
- **Core**: Add Flatpak runtime compatibility (a2324c80)
- **Core**: Add Immich plugin reference for tests. (7a200025)
- **Core**: Add iOS-style SXCU custom uploaders (3d59830e)
- **Core**: Add KFIP0003 community plugin registry proposal (258849a6)
- **Core**: Add KFIP0004 community plugin registry proposal (cdab25cb)
- **Core**: Add macOS capture sound setting (1152cf59)
- **Core**: Add Pixelfox draft registry entry (456bf70c)
- **Core**: Add privacy manifests (c3188c82)
- **Core**: Add ReClip CLI integration commands (4fc57158)
- **Core**: Address XDG Flatpak readiness (585c7c09)
- **Core**: Align App Store version (bf327780)
- **Core**: Align macOS capture sound fallback (b2e070db)
- **Core**: Avoid unread native notification pipes (17c2a356)
- **Core**: Bump version after origin release sync (b30a0ee6)
- **Core**: Bump version after v0.22.71 sync (c53b3608)
- **Core**: Bump version to 0.22.113 (91346c8d)
- **Core**: Bump version to 0.22.85 (193432ca)
- **Core**: Bump version to 0.22.92 (1d08fb88)
- **Core**: Clamp Imgur explorer page sizes (6db09fa8)
- **Core**: Copy share upload results like iOS (82f8c5ea)
- **Core**: Correct hourly verification notes (bc030f8f)
- **Core**: Correct workflow config tracker test count (87e952ad)
- **Core**: Create Apple_Developer_Program_License_Agreement_854R8GJUBL.pdf (f4f5536e)
- **Core**: Create feature-graphic.png (7aba92c8)
- **Core**: Create play-preview-assets-guidelines.md (eabdc09b)
- **Core**: Declare export compliance (aa51a879)
- **Core**: Enable automatic signing attributes (a3d99aab)
- **Core**: Exclude sensitive mobile data from backup (92e51386)
- **Core**: Fix assistant alias deletion (bef6d334)
- **Core**: Fix assistant alias override precedence (0a883229)
- **Core**: Fix assistant copy paths alias (e256f43e)
- **Core**: Fix assistant history basename fallback (8e43d834)
- **Core**: Fix assistant OCR history path normalization (1538692f)
- **Core**: Fix assistant screenshot history paging (776075a1)
- **Core**: Fix case-insensitive uploader instance IDs (a12d09ed)
- **Core**: Fix CLI region workflow timeout handler and completion leak (9c15f20a)
- **Core**: Fix CLI upload JSON output (9db407f5)
- **Core**: Fix CLI uploader bootstrap path (129cb2d2)
- **Core**: Fix clipboard upload uploader attribution (fc83da17)
- **Core**: Fix combined video thumbnail timestamp alignment (287f1afb)
- **Core**: Fix compare-capture region validation (6a83d72a)
- **Core**: Fix cross-platform path handling in GetHistoryFileName (634125b6)
- **Core**: Fix duplicate plugin load context replacement (1ef0fa55)
- **Core**: Fix DXGI capture crop rectangle conversion (c5122379)
- **Core**: Fix editor close session completion (375d4435)
- **Core**: Fix editor session source snapshot (db7c97f1)
- **Core**: Fix FFmpeg thumbnail failure handling (d65eb7e6)
- **Core**: Fix FFmpegAudioCodec default from libvoaacenc (invalid) to aac (13a54f58)
- **Core**: Fix FTP @ home path URL handling (c81e06c5)
- **Core**: Fix FTP host normalization (7ef08654)
- **Core**: Fix FTP HTTP home path URL normalization (2323f8b8)
- **Core**: Fix FTP IPv6 public URL generation (f22f4e79)
- **Core**: Fix FTP query template subfolder URLs (b2620af9)
- **Core**: Fix FTP remote filename sanitization (083bc893)
- **Core**: Fix FTP retry directory path handling (31e3a48f)
- **Core**: Fix FTP uploader port normalization (84b153fd)
- **Core**: Fix GDI capture rect rounding parity (71f33d68)
- **Core**: Fix headless editor unavailable result (b25cfaa6)
- **Core**: Fix history editor source file release (4bca76a4)
- **Core**: Fix history lookup symlink equivalence (bf4cbdde)
- **Core**: Fix hotkey duplicate command to deep-copy TaskSettings instead of sharing reference (063bbd40)
- **Core**: fix IgnoreEmptyFolders and folder-size stats for async text output (c91330c3)
- **Core**: Fix image preset save into missing folders (2f58c41e)
- **Core**: Fix Imgur album image URL escaping (a2cfe782)
- **Core**: Fix Imgur client ID normalization (833c1418)
- **Core**: Fix Immich album placeholder name loss when only AlbumName is persisted (779f641f)
- **Core**: Fix indexer negative depth traversal (62d693a0)
- **Core**: Fix Indexer totalFoldersProcessed off-by-one (+ regression tests) (afc512d0)
- **Core**: Fix Linux clipboard owner process disposal and monitor stop timeout handling (431a4048)
- **Core**: Fix Linux hotkey modifier matching (0a560ddb)
- **Core**: Fix Linux sandbox app id normalization (1bea7609)
- **Core**: Fix Linux X11 frame extent overflow handling (5e8e60d7)
- **Core**: Fix macOS CLI capture region scaling (9c82cb36)
- **Core**: Fix macOS clipboard file drop parsing (f44a8a81)
- **Core**: Fix macOS clipboard file-drop path normalization (9746cd00)
- **Core**: Fix macOS clipboard osascript helper launch (bbba31da)
- **Core**: Fix macOS history path casing lookup (f069af90)
- **Core**: Fix macOS region selector exclusivity (10f90deb)
- **Core**: Fix macOS region selector preference (5c6e18a2)
- **Core**: Fix MCP headless editor unavailable contract (911a80f2)
- **Core**: Fix MCP string param validation (5e4cd4ad)
- **Core**: Fix mixed-size video thumbnail sheets (c9614505)
- **Core**: Fix Nextcloud PROPFIND propstat parsing (4bd3c229)
- **Core**: Fix Nextcloud relative path dot segments (aea0da17)
- **Core**: Fix Nextcloud server URL normalization (c7f29ad8)
- **Core**: Fix notification timeout process cleanup (84c199d0)
- **Core**: Fix null deref in CaptureCommand metadata URL access (2d59f904)
- **Core**: Fix OCR language selection normalization (0982876c)
- **Core**: Fix onboarding OCR language refresh cleanup (cf02727d)
- **Core**: Fix plugin context provider ID casing (2253bb1d)
- **Core**: Fix plugin directory dependency fallback (44ab0f4c)
- **Core**: Fix plugin load context unload tracking (05b935b0)
- **Core**: Fix plugin manifest entry casing validation (4c89e98d)
- **Core**: Fix plugin package install root creation (db8077d8)
- **Core**: Fix plugin package preview manifest validation (4f84f44d)
- **Core**: Fix provider catalog ID casing (5d3bc60c)
- **Core**: Fix random thumbnail seek slot selection (9443a9bd)
- **Core**: Fix reset backup timestamp collisions (4b38902e)
- **Core**: Fix S3 mobile destination export validation (20ad2d59)
- **Core**: Fix settings memory stream rewind (c8ff0eb0)
- **Core**: Fix settings upgrade version detection (e3e44c86)
- **Core**: Fix SFTP password fallback for invalid keys (dd54bd12)
- **Core**: Fix SFTP upload speed by replacing SftpFileStream + TransferData() with SftpClient.UploadFile() (c6dc745d)
- **Core**: Fix SKBitmap resource leaks in PinToScreenManager callers (c05298e2, d4ffe767)
- **Core**: Fix stale assistant OCR cache (410d6602)
- **Core**: Fix sticky toast validation (844ce993)
- **Core**: Fix thumbnail FFmpeg timeout cleanup (fbeb25cf)
- **Core**: Fix unique file path suffix overflow (55c0210b)
- **Core**: Fix unique path directory collisions (21eb680a)
- **Core**: Fix uploader fallback after primary failure (c5bffc9f)
- **Core**: Fix URL path encoding breaking FTP/SFTP result URLs (b3414928)
- **Core**: Fix video thumbnail grid column validation (dcc22744)
- **Core**: Fix VideoThumbnailer.CombineScreenshots early-return leak in inner loop (012614ee)
- **Core**: Fix Wayland portal keypad hotkey accelerators (0f07f124)
- **Core**: Fix Wayland portal shortcut snapshot refresh (243f1c69)
- **Core**: Fix Wayland portal spacebar accelerator (0efc53a8)
- **Core**: Fix weekly settings backup creation (10c1d520)
- **Core**: Fix workflow config repair for missing task settings (f94657aa)
- **Core**: Fix workflow hotkey retry after stale failed id (ab1bac0c)
- **Core**: Fix WorkflowCommand region-override timeout handler deregistration order (d2c0798e)
- **Core**: Fix zero-duration toast fade startup (f9725dc6)
- **Core**: Force collection after failed plugin load cleanup (044ddc06)
- **Core**: Guard blank provider catalog lookups (f59f930b)
- **Core**: Guard blank provider registration (53ae7373)
- **Core**: Guard configured capture region bounds (de30bace)
- **Core**: Guard duplicate plugin manifest tracking (ed2ea627)
- **Core**: guard HandleExistsFile Cancel/Ask results across task/file write paths (959a8dcd)
- **Core**: Handle malformed Hyprland coordinate arrays (b2378eb6)
- **Core**: Harden KDE Wayland geometry parsing (cc16b61a)
- **Core**: Harden MCP annotation parameter parsing (c85fa717)
- **Core**: Harden MCP test adapter asset metadata (86f2f7cf)
- **Core**: Harden NUnit test asset metadata (9be90cc8)
- **Core**: Harden plugin cleanup dependency paths (1597c9eb)
- **Core**: Harden plugin cleanup deps asset paths (b1f155fd)
- **Core**: Harden plugin loaded-context snapshots (d4998384)
- **Core**: Harden plugin package entry path extraction (bc98cab8)
- **Core**: Harden plugin unload id handling (1e871f4a)
- **Core**: Harden Sway Wayland rect parsing (c2237751)
- **Core**: Harden test project build isolation (740b1749)
- **Core**: Ignore local signing env (5e2e3618)
- **Core**: Improve missing dependency plugin diagnostics (4c62eaa4)
- **Core**: Improve plugin bad image load diagnostics (cf543293)
- **Core**: Improve plugin dependency load diagnostics (c5aaa57d)
- **Core**: Improve plugin missing assembly diagnostics (09164f3c)
- **Core**: Improve plugin missing dependency diagnostics (a40353a8)
- **Core**: Improve plugin type-load diagnostics (265203de)
- **Core**: Improve reflection loader dependency diagnostics (99a39311)
- **Core**: Match iOS S3 endpoint options (e49c0c51)
- **Core**: Merge history into home (9b15903c)
- **Core**: Normalize assistant OCR options (6a861cc1)
- **Core**: Normalize OCR options (324ec2f3)
- **Core**: Notify settings observers after uploader config saves (770802c0)
- **Core**: Preserve upload result URLs in history (1a5beb4e)
- **Core**: Protect Android mobile secrets (4ead2511)
- **Core**: Protect assistant confirmation copy path privacy (74128441)
- **Core**: Publish Pixelfox registry package (9a538b90)
- **Core**: Record final origin sync in hourly tracker (81dc649e)
- **Core**: Refine Linux region selector support (f457d15b)
- **Core**: Refresh macOS release assets (fca5a53e)
- **Core**: Regenerate Logo.ico with multi-resolution sizes (16/32/48/64/128/256) (9de7ffe1)
- **Core**: Reject overflowing CLI capture regions (ed89a116)
- **Core**: Rename community plugin registry proposal to KFIP0004 (79d648a1)
- **Core**: Route prerelease update checks (ded15cfa)
- **Core**: Store uploader secrets in Keychain (8cbcdd68)
- **Core**: Surface destination config export in provider settings (8f074e3e)
- **Core**: Sync ImageEditor with latest ShareX (931171a7)
- **Core**: Sync ImageEditor with latest ShareX updates (c624b895)
- **Core**: Target API 35 for Play (d09e41e0)
- **Core**: Unload plugin contexts on provider catalog clear (ef598884)
- **Core**: Update app logo and ShareX icon assets (bd5dc257)
- **Core**: Update App Store identifiers (1acb8e4f)
- **Core**: Update assistant privacy review verification notes (08d9012e)
- **Core**: Update hourly review tracker (20238ec5, 23080de2, 825a3e43)
- **Core**: Update hourly review tracker after origin sync (04a6ac4e)
- **Core**: Update hourly review tracker for media pass (ddabd0a8)
- **Core**: Update hourly review tracker for Wayland window query sweep (e457a10c)
- **Core**: Update hourly tracker push status (26586553)
- **Core**: Update hourly tracker test totals (7cc4290f)
- **Core**: Update Logo.ico (8d84ee7c)
- **Core**: Use native top-level navigation (259eccee)
- **Core**: Use ShareX icon in AboutView (35d1087a)
- **Core**: Validate declared plugin package assets (3aeec9c2)
- **Core**: Validate plugin dependency manifest paths (bb92deb1)
- **Core**: Validate plugin provider ids before tracking contexts (1210369a)
- **Fix Three Clipboard/UI Bugs**: process leak on exception, temp file leak, and using var conflict (6b3fe481)
- **Fix ToastWindow**: wire right-click to ExecuteRightClick() and fix flyout menu opacity handlers (9a1ff6b0)
- **Fix VideoHelpers**: default dither to sierra2_4a to match ShareX upstream (ef2390c5)
- **KFIP0006**: Add Named Region Shortcuts proposal (60e25b4a)
- **Update Hourly Review Tracker**: CLI region workflow handler fix (1d74c415)
- **Update Hourly Review Tracker**: Indexer subsystem fix (1282a4a7)
...
### Documentation
- **Core**: Add 2026-04-25 engineering blog draft. (3acabb15)
- **Core**: Add 2026-04-25 maintenance blog draft. (a5af5619)
- **Core**: Add 2026-04-26 quiet day blog draft. (d48779c8)
- **Core**: Add 2026-04-26 upload-fixes blog draft. (60ec6727)
- **Core**: Add 2026-04-27 VideoEditor integration blog draft. (85346893)
- **Core**: Add 2026-04-27 stabilization blog draft. (4b254e01)
- **Core**: Add 2026-04-28 stabilization blog draft. (71a5abdc)
- **Core**: Add 2026-04-29 no-activity blog draft. (067be5f5)
- **Core**: Add 2026-04-29 release-readiness blog draft. (ca22c665)
- **Core**: Add 2026-04-30 no-activity blog draft. (07db2718)
- **Core**: Add 2026-05-01 settings follow-up blog draft. (03095c6b)
- **Core**: Add 2026-05-01 stabilization blog draft. (27e14ef8)
- **Core**: Add 2026-05-02 no-activity blog draft. (ee08007a)
- **Core**: Add Android Play submission checklist (2b05ddd1)
- **Core**: Add Android Play submission materials (a48dbe05)
- **Core**: Add experimental mobile parity workflow (777d7af9)
- **Core**: Add mobile parity workflow (ddbcaab6)
...
- **Core**: Update app logo and ShareX icon assets (bd5dc257)
- **Core**: Update assistant privacy review verification notes (08d9012e)
- **Core**: Update hourly review tracker (20238ec5)
- **Core**: Update hourly review tracker after origin sync (04a6ac4e)
- **Core**: Update hourly review tracker for Wayland window query sweep (e457a10c)
- **Core**: Update hourly review tracker for media pass (ddabd0a8)
- **Core**: Update hourly tracker test totals (7cc4290f)
