...
public sealed class ImmichUploader : FileUploader
{
    ...
    public ImmichUploader(ImmichConfigModel config, string apiToken)
    {
    ...
    public override UploadResult Upload(Stream stream, string fileName)
    {
        ...
        Errors.Add("Replace the scaffolded upload logic in ImmichUploader.Upload with service-specific request code.");
        return result;
    }
}
