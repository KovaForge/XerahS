...
public class NextcloudConfigModel
{
    ...
    public string RemotePath { get; set; } = "ShareX/%y/%mo";
    public bool CreatePublicShare { get; set; } = true;
    public bool AutoExpireShare { get; set; }
    public int ExpireAfterDays { get; set; } = 7;
    public bool UseChunkedUpload { get; set; } = true;
    public int ChunkSizeMiB { get; set; } = 10;
    public string ServerVersion { get; set; } = string.Empty;
    public string ServerProductName { get; set; } = "Nextcloud";
    public string ThemingName { get; set; } = string.Empty;
    public bool SupportsPublicShares { get; set; } = true;
