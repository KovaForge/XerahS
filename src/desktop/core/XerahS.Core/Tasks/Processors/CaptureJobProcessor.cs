...
namespace XerahS.Core.Tasks.Processors
{
    public class CaptureJobProcessor : IJobProcessor
    {
        ...
        /// On the capture path this runs when Auto is selected and recurses for File-category fallback.
        /// A fixed (non-Auto) image destination does not use this after a failed upload—see docs/architecture/UPLOAD_DESTINATION_AND_FALLBACK.md.
        /// </summary>
