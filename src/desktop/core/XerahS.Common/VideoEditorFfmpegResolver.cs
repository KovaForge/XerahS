...
public static class VideoEditorFfmpegResolver
{
    public static (string ConfiguredPath, bool IsAvailable, string Source) Resolve(
        string? hostPath,
        string? detectedPath)
    {
        ...
        string normalizedDetectedPath = NormalizePath(detectedPath);
