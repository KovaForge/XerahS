...
/// <summary>
/// Static pixel grid, center-cell outline, and accent row/column highlight
/// for the region magnifier. Grid lines are snapped to physical pixels.
/// </summary>
public sealed class MagnifierPixelGrid : Control
{
    ...
    public static readonly StyledProperty<int> PixelCountProperty =
        AvaloniaProperty.Register<MagnifierPixelGrid, int>(nameof(PixelCount), MagnifierLayout.DefaultPixelCount);
    ...
    public override void Render(DrawingContext context)
    {
        ...
        // Start the center outline there too so the highlight sits on the grid.
        centerLeft--;
        centerTop--;
