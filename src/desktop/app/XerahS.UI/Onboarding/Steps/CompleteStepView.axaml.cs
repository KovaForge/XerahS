        ...
        try
        {
            ...
            if (SuccessCircle is Ellipse circle)
            {
                var fadeAnim = new Animation
                {
                    ...
                    Easing = new SplineEasing(0, 0, 0.25, 1),
                    Children =
                    {
                        new KeyFrame { Cue = Cue.Parse("0%", System.Globalization.CultureInfo.InvariantCulture), Setters = { new Setter(Visual.OpacityProperty, 0.6) } },
                        new KeyFrame { Cue = Cue.Parse("100%", System.Globalization.CultureInfo.InvariantCulture), Setters = { new Setter(Visual.OpacityProperty, 1.0) } }
                    }
                };
            ...
            if (CheckMark is Path path)
            {
                ...
                var drawAnim = new Animation
                {
                    ...
                    Children =
                    {
                        new KeyFrame { Cue = Cue.Parse("0%", System.Globalization.CultureInfo.InvariantCulture), Setters = { new Setter(Visual.OpacityProperty, 0.0) } },
                        new KeyFrame { Cue = Cue.Parse("100%", System.Globalization.CultureInfo.InvariantCulture), Setters = { new Setter(Visual.OpacityProperty, 1.0) } }
                    }
                };
