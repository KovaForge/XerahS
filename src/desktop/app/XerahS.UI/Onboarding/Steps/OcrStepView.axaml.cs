...
public partial class OcrStepView : UserControl
{
    ...
    private void OnLanguageCheckClicked(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        // Force property change notification to refresh the checkbox bindings
        vm.PropertyChanged?.Invoke(vm, new System.ComponentModel.PropertyChangedEventArgs(nameof(OcrStepViewModel.SelectedLanguages)));
    }
}
