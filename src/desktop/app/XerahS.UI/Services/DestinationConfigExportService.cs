        ...
        return new JObject
        {
            ...
            ["Destinations"] = new JArray
            {
                new JObject
                {
                    ...
                    ["IsDefault"] = string.Equals(InstanceManager.Instance.GetDefaultInstance(instance.Category)?.InstanceId, instance.InstanceId, StringComparison.OrdinalIgnoreCase),
                    ["Config"] = new JObject
                    {
                        ["AuthMode"] = "AccessKeys",
