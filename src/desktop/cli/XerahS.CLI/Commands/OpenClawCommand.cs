    ...
    public static OpenClawManifest BuildManifest()
    {
        return new OpenClawManifest(
            ...
            [
                ...
                new OpenClawManifestCommand("cloud status --json", "Show XerahS Cloud OAuth configuration and session state", true, false),
                new OpenClawManifestCommand("cloud sign-in --json", "Open the system browser and complete XerahS Cloud OAuth", true, true),
