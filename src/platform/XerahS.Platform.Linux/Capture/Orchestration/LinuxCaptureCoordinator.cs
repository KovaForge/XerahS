...
internal sealed class LinuxCaptureCoordinator
{
    private readonly IReadOnlyList<ILinuxCaptureProvider> _providers;
    private readonly ILinuxCapturePolicy _policy;

    public LinuxCaptureCoordinator(IEnumerable<ILinuxCaptureProvider> providers, ILinuxCapturePolicy policy)
    {
