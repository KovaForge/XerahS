...
*   **Solution (Smart Fallback):** XerahS detects if silent capture is blocked. Instead of showing a broken overlay or forcing you to click through dialogs, it will **automatically fall back to the system's native region tool** (Portal). This ensures you can always take a screenshot without complex workarounds.
