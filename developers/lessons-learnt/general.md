...
- Keep Flatpak CI validation aligned with the manifest-installed icon bucket. If `flatpak-builder` exports `share/icons/hicolor/512x512/apps/com.getsharex.XerahS.png`, the release workflow must validate that exact path instead of an older `256x256` path.
