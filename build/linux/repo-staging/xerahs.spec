# First-party COPR / OBS spec for the published Linux payload.
...
# Do not dput / copr build / osc commit from this file automatically.
...
the GitHub release. It is the COPR / OBS counterpart of the
